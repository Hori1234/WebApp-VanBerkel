...
export default class Home extends Component {
    render() {
        return (
            <Layout style={{flexDirection: "row", alignItems: "center", display: "flex", width: "100%", justifyConten: "space-around"}}>
                <Layout style={{alignItems: "flex-start", display: "flex", justifyContent: "space-around", marginBottom: 50, marginRight: 100}}>
                    ...
                    <Layout style={{flexDirection: "row", alignItems: "center", display: "flex", width: "100%"}}>
                        <Image style={{marginRight: 20}}
                            preview={false}
                            width={100}
                ...
                <Layout style={{justifyContent: "space-around", marginBottom: 50, display: "flex", alignItems: "flex-start"}}>
                    ...
                    <Layout style={{flexDirection: "row", alignItems: "center", display: "flex", width: "100%"}}>
                        ...
                        />
                        <Layout style={{flexDirection: "column"}}>
                            <Text style={{fontWeight: "bold", fontSize: "18"}}>Data Analytics</Text>
