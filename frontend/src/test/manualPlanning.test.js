...
describe('React App', () => {
    ...
    it('shall succesfully magnify the orders', async () => {
      ...
      it('shall succesfully edit an order', async () => {
        ...
        await page.click('#root > section > section > section > section > main > section > section > div:nth-child(1) > div.ant-col.ant-col-8 > div > div');
        await page.waitFor(500);
        await page.click('body > div:nth-child(8) > div > div > div > div.rc-virtual-list > div > div > div > div:nth-child(2)');

        await page.waitFor(500);
        await page.click('#root > section > section > section > section > main > section > section > div:nth-child(1) > div.ant-col.ant-col-8 > div > div');
        await page.waitFor(500);
        await page.click('body > div:nth-child(8) > div > div > div > div.rc-virtual-list > div > div > div > div:nth-child(1)');
      ...
      it('shall succesfully add an entry in orders table', async () => {
        ...
        await page.type('#nest-messages_orderNumber', 'test');
