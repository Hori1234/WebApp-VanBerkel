...
describe('React App', () => {
  ...
  it('succesfully go to the upload page with the side menu after logging in', async () => {
  ...
  it('succesfully go to the manual planning page with the side menu after logging in', async () => {
  ...
  it('succesfully go to the view planning page with the side menu after logging in', async () => {
  ...
  it('succesfully go to the data visualisation page with the side menu after logging in', async () => {
  ...
  it('succesfully go to the monthly data analytics page with the side menu after logging in', async () => {
